...
sys.path.append("~/.local/lib/python3.7/site-packages/websockets")
sys.path.append("/usr/local/lib/python3.7/dist-packages/websockets")
sys.path.append("/home/pi/.local/lib/python3.7/site-packages/websockets")
